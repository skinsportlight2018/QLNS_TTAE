...
<input type="hidden" name="txtid" value="<?php echo $nv["id"]; ?>">
            ...
            <div class="card shadow mb-4" style="margin-left:10px;">
                ...
                <div class="card-body">
                    ...
                    <div class="my-1">    
                    <label for="opttrangthai" class="form-label">Giới tính</label> <a class="Sao">*</a>
                        ...
                        <div class="col">                            
                            ...
                            <div class="my-1">    
                                ...
                                <div>
                                    ...
                                    <a href="#" onclick="document.getElementById('demo').classList.toggle('collapse')">Đổi hình ảnh</a>
                                </div>
                            </div>
