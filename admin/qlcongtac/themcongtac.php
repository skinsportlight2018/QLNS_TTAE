...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
	<div class="container">
		<h1 class="h3 mb-0 custom-heading">Thêm công tác</h1>
	</div>
</nav>
            ...
            <div class="card shadow mb-4" style="margin-left:10px;">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col"> 
                            ...
                            <div class="my-1">    
                                ...
                                <input class="form-control" type="text" name="txtmacongtac" style="font-size: 13px" placeholder="Nhập mã công tác"required>
                            </div>
                            ...
                            <div class="my-1">    
                                ...
                                <select class="form-control" name="opttennhanvien" style="font-size: 13px">
                                    ...
                                    ?>
                                        <option value="<?php echo $nv["id"]; ?>"><?php echo $nv["manv"]; ?> - <?php echo $nv["hotennv"]; ?></option>
                                    <?php
                                    endforeach;
                                    ?>
                                </select>
                            ...
                            <div class="my-1">    
                                ...
                                <input class="form-control" type="text" name="txtdiadiem" style="font-size: 13px" placeholder="Nhập địa điểm" required>    
                            </div>
                        ...
                        <div class="col">                            
                            ...
                            <div class="my-1">    
                                ...
                                <input class="form-control" type="date" name="txtngaybd" style="font-size: 13px"required>    
                            </div> 

                            <div class="my-1">    
                                <label class="form-label">Ngày kết thúc</label>
                                <input class="form-control" type="date" name="txtngaykt" style="font-size: 13px"  required>    
                            </div> 

                            <div class="my-1">    
                                <label class="form-label">Ghi chú</label>
                                <input class="form-control" type="text" name="txtghichu" style="font-size: 13px">    
                            </div>  
                    ...
                    <div class="my-1">    
                        ...
                        <textarea class="form-control" id="nhiemvu_congtac" name="txtnhiemvu_congtac" style="font-size: 13px" placeholder="Nhập số Căn cước công dân" required></textarea>
                    </div>
