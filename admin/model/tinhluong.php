...
class TinhLuong {
    ...
    public function tinhLuongNhanVien($maluong, $manhanvien, $soNgayCong, $tamUng, $moTa, $ngayTinhLuong) {
        ...
        if (!empty($tamUng) && !is_numeric($tamUng)) {
            $error['tamUngSo'] = 'error';
        }
        ...
        if (empty($error)) {
            ...
            {
                $phuCapCalculated = 50000 * $soNgayCong;
                $luongThang = ($soNgayCong * $getLuongNgay) + $phuCapCalculated;
            }
            ...
            $insert = "INSERT INTO luong(maluong, nhanvien_id, luongthang, phucap, ngaycong, khoannop, tamung, thuclanh, ngaychamcong, ghichu) 
                        VALUES('$maluong', $manhanvien, $luongThang, $phuCapCalculated, $soNgayCong, $tongKhoanTru, $tamUng, $thucLanh, '$ngayTinhLuong', '$moTa')";
